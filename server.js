...
router.get('/', function(req, res) {
  res.json({
    description: 'Welcome to AaronChuo Portfolio API !',
    owner: 'Aaron Chuo',
    version: '0.0.1',
    api: [
      {router: 'profile', description: 'CRUD api for my personal profile.'},
      {router: 'exp', description: 'CRUD api for my professional experiences.'},
      {router: 'work', description: 'CRUD api for my works.'}
    ]
  });
});
